...
from agents.tools import Error, File, LintCodeToolResult, TestCodeTool, TestCodeToolResult, Tool
...
class CoderAgent(Agent):
    ...
    specific_context: CoderContext = CoderContext()
    ...
    def get_output(self) -> CoderOutput:
        return CoderOutput(
            code_changes=self.specific_context.code_changes,
            tests_passed=self.specific_context.tests_passed,
            lint_check_passed=self.specific_context.lint_check_passed,
        )
...
class CoderAgentTool(Tool):
    ...
    def run(self, agent_config: AgentConfig) -> CoderOutput:
